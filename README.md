...
- [x] **PPT/Pitch deck link** — [View Pitch Deck](https://docs.google.com/presentation/d/1cJhh7a_jayD9u_8WfKjT2OYxfB9oj-dO/edit?usp=sharing)
- [x] **Demo video link** — [Watch Demo](https://drive.google.com/file/d/1hYrrzoaLywGsKFArdjeHYvR-ranxJ5oH/view?usp=sharing)
...
- [x] **Google Sheet response export** — [open native Google Sheet](https://docs.google.com/spreadsheets/d/126_dKrUCz41kpdDj0AH30HRrrXlGUP0L2oDMmt4bC2Q/edit?usp=drivesdk)

### Feedback survey

Have you tried Komunitas? [**Share your feedback**](https://docs.google.com/forms/d/e/1FAIpQLSddg-GUsT3SPZkfFwA_kBWotNESSWvtREjve0f_wFkSVpfjhg/viewform) — a 2-minute public survey. Responses are collected in the feedback sheet linked above.
...
- Feedback validation: `node scripts/build-submission-proof.mjs`
...
| Google Sheet response export | https://docs.google.com/spreadsheets/d/126_dKrUCz41kpdDj0AH30HRrrXlGUP0L2oDMmt4bC2Q/edit?usp=drivesdk |
...
| [`docs/user-feedback-log.md`](docs/user-feedback-log.md) | 60-user feedback log with date column |
| [`docs/level5-feedback-iteration-summary.md`](docs/level5-feedback-iteration-summary.md) | Feedback-to-iteration map |
| Google Sheet response export | https://docs.google.com/spreadsheets/d/1B53CtHIra73rYwXIbojylEyIe0D1rSjm7SoLsRt--x0/edit?usp=drivesdk |
...
| Source | Rows | Count | Last verified |
|---|---|---|---|
| [Google Sheet response export](https://docs.google.com/spreadsheets/d/1B53CtHIra73rYwXIbojylEyIe0D1rSjm7SoLsRt--x0/edit?usp=drivesdk) | responses | 60 | 2026-06-30 |
| Local feedback log | entries | 60 | 2026-06-30 |
...
```
https://docs.google.com/spreadsheets/d/126_dKrUCz41kpdDj0AH30HRrrXlGUP0L2oDMmt4bC2Q/edit?usp=drivesdk    # native Google Sheet response export
```
...
- **Testnet (default in `src/server/config/env.ts`)** — `CBVWE2OYZMFDMYN6DT5JMIJCUOIYABUAPONISO7EX7HSUTIYMNN67NIX` · https://stellar.expert/explorer/testnet/contract/CBVWE2OYZMFDMYN6DT5JMIJCUOIYABUAPONISO7EX7HSUTIYMNN67NIX
- **Mainnet (live deployment per `contracts/DEPLOYMENT.md`)** — `CDNEHSQ5PWYC6AXNA4PIEAXCEUNUSVDAOKIVEBEHTRY2SEUJANSMWFVR` · https://stellar.expert/explorer/public/contract/CDNEHSQ5PWYC6AXNA4PIEAXCEUNUSVDAOKIVEBEHTRY2SEUJANSMWFVR

> Per project owner direction, the Level 5 evidence package uses **testnet** wallets and the testnet contract for transaction references. Mainnet tx hashes are flagged as TODOs in `docs/level5-data-integrity-notes.md` for the owner to swap in later.

### Testnet deployment tx references (from `contracts/DEPLOYMENT.md`)

- Deploy (instantiate): `e081d5b884b0c00d81f2ca6020ddeaa7efb0e1a70ec74d27a15759ce0fceaf8a` — https://stellar.expert/explorer/testnet/tx/e081d5b884b0c00d81f2ca6020ddeaa7efb0e1a70ec74d27a15759ce0fceaf8a
- `initialize(admin, token)`: `99c30342f097ad3ddfd16331f6c7293c090a32facb75ce37906973add2048eff` — https://stellar.expert/explorer/testnet/tx/99c30342f097ad3ddfd16331f6c7293c090a32facb75ce37906973add2048eff

Mainnet tx hashes from the live deployment are recorded in `contracts/DEPLOYMENT.md` and surfaced in `docs/level5-data-integrity-notes.md` as the swap-in placeholders:

```
// TODO: insert real mainnet contribute / propose / vote / disburse tx hashes from stellar.expert public explorer
```
